...
//         return console.log(`You are elegiable for delivery with zip code: ${zipCode}`)
//     }else{
//         return console.log(`Sorry, zip code: ${zipCode} is not in our delivery zone.`)
//     }
// }
